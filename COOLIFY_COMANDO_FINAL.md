...
## Ou use o arquivo JavaScript (se estiver no servidor):

```bash
cd /app && node insert-suitpay-credentials.js
```

## Ou crie o arquivo no diretório do projeto:
